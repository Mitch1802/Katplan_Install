...
sudo docker stop katplan_nginx
sudo docker stop katplan_db
sudo docker stop katplan_api
sudo docker remove katplan_nginx
sudo docker remove katplan_db
sudo docker remove katplan_api
